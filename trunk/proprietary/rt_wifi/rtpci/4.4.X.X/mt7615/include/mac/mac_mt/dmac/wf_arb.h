...
#define ARB_RQCR_RX_START		    0x01        /* BIT0  */
#define ARB_RQCR_RX_RESET		    0x04        /* BIT2  */

#define ARB_RQCR_RXV_START		    0x10        /* BIT4  */
#define ARB_RQCR_RXV_R_EN		    0x80        /* BIT7  */
#define ARB_RQCR_RXV_T_EN		    0x100       /* BIT8  */
#define ARB_RQCR_RX1_START		    0x010000    /* BIT16 */    
#define ARB_RQCR_RXV1_START	        0x100000    /* BIT20 */
#define ARB_RQCR_RXV1_R_EN		    0x800000    /* BIT23 */
#define ARB_RQCR_RXV1_T_EN		    0x1000000   /* BIT24 */

/* [24,23,20,16,8,7,4,0] = 0x1910191 */
#define ARB_RQCR_ALL_RXQ_EN_MASK (ARB_RQCR_RX_START | ARB_RQCR_RXV_START | ARB_RQCR_RXV_R_EN | ARB_RQCR_RXV_T_EN | ARB_RQCR_RX1_START | ARB_RQCR_RXV1_START | ARB_RQCR_RXV1_R_EN | ARB_RQCR_RXV1_T_EN)
...
#define MT_ARB_SCR_DISABLE_PHY_MASK (MT_ARB_SCR_TXDIS | MT_ARB_SCR_RXDIS | MT_ARB_SCR_TX1DIS | MT_ARB_SCR_RX1DIS)
