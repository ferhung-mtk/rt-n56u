...
// External APIs
BOOLEAN ReduceTcpAck(RTMP_ADAPTER* pAd, PNDIS_PACKET pPacket);//For TX ACK reduction
BOOLEAN ReduceAckUpdateDataCnx(RTMP_ADAPTER* pAd, PNDIS_PACKET pPacket); // For RX Data statistics update
